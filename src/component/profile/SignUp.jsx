                    ...
                    <form className=" sm:p-8 p-6 w-full" onSubmit={handleSubmit}>
                        ...
                        <div className="grid lg:grid-cols-1 gap-8">
                            ...
                            <div>
                                ...
                                <input name="email" type="text" className="bg-slate-100 w-full text-slate-800 text-sm px-4 py-2.5 rounded-md border border-gray-200 focus:bg-transparent focus:border-black outline-none transition-all" placeholder="Enter email" value={emailId} onChange={(e) => setEmailId(e.target.value)} />
                            </div>
                        ...
                        <div className="mt-8">
                            ...
                            <div>
                                <p class="text-slate-600 text-sm mt-6 text-center">Already have an account?  <Link
                                    to="/login"
